...
public class GiveHelpActivity extends AppCompatActivity implements View.OnClickListener{

    public static final String JSON_URL = "http://simplecoding.16mb.com/ImageUpload/give-help.php";
        ...
        StringRequest stringRequest = new StringRequest(JSON_URL,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(GiveHelpActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void showJSON(String json){
        ...
        CustomList2 cl = new CustomList2(this,ParseJSON2.name,ParseJSON2.city,ParseJSON2.phone,ParseJSON2.email,ParseJSON2.desc);
